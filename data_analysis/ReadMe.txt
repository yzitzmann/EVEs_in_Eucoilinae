...
The scripts "EVE_analysis.R" and "EVE_phylogeny.R" work with the confirmed EVEs and Filamentoviridae EVE phylogenies, respectively.

Detailed Description:
"Analysis and visualization of the final EVE dataset was conducted in R Version 4.4.0 (R Core Team, 2024) using the tidyverse (Wickham et al., 2019) as well as packages car (Fox & Weisberg, 2019), ape (Paradis & Schliep, 2019), phytools (Reell, 2024), RRphylo (Castiglione et al., 2020), ggplot2 (Wickham, 2016), ggstance (Hentry et al., 2024) and ggtree (Guangchuang, 2022)."
...
Revell, LJ (2024) phytools 2.0: an updated R ecosystem for phylogenetic comparative methods (and other things).
	PeerJ, 12, e16505
